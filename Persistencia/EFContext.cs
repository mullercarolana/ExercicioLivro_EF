...
namespace Persistencia
{
	public class EFContext : DbContext
	{
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
			...
			var cc = new Curso() { CursoID = 1, Nome = "Ciências da Computação", CargaHoraria = 3600 };
			...
			var lpe = new Disciplina() { DisciplinaID = 1, Nome = "Linguagem de Porgramação Estruturada", CursoID = 1 };
			var oo = new Disciplina() { DisciplinaID = 2, Nome = "Programação Orientada a Objetos", CursoID = 2 };
